...
public class Professor extends Pessoa implements Observer, Agendavel {
	...
	private List<Observer> alunosInscritos = new ArrayList<>(); // Lista de alunos inscritos no curso do professor
	...
	// Método para adicionar apenas alunos do curso do professor
	...
	// Método para notificar apenas os alunos inscritos
	public void notificarObservers(String mensagem) {
		for (Observer aluno : alunosInscritos) {
			aluno.update(mensagem); // Notifica apenas alunos inscritos no curso do professor
		}
	}
